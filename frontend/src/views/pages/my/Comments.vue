    ...
    <div class="comments-content">
        <div class="mb-6 p-4 bg-orange-50 border-l-4 border-orange-500 rounded-r">
            <p class="text-gray-700 italic">
                카드를 클릭하면 해당 레시피 상세 페이지의 댓글 영역으로 이동해요.
            </p>
        </div>
        ...
        <div class="comments-section">
            ...
            <PageStateBlock
                v-if="loading"
                state="loading"
                loading-message="내 댓글을 불러오는 중..."
            />
            <PageStateBlock
                v-else-if="error"
                state="error"
                error-title="내 댓글을 불러올 수 없습니다"
                :error-message="error"
                retry-label="다시 시도"
                @retry="loadMyComments"
            />
            <PageStateBlock
                ...
                empty-message="내 댓글을 보려면 로그인해 주세요."
                    ...
                    >
                        ...
                        <div class="comment-card__recipe">
                            <div class="comment-card__recipe-thumb">
                                <img
                                    :src="item.recipeThumbnail || '/placeholder-recipe.jpg'"
                                    :alt="item.recipeTitle"
                                    class="comment-card__recipe-img"
                                />
                            </div>
                        ...
                        <div class="comment-card__comment">
                            ...
                            <div v-if="item.comment.imageUrl" class="comment-card__comment-image-wrap">
                                <img
                                    ...
                                    alt="댓글 이미지"
                                    class="comment-card__comment-image"
                                />
                            </div>
