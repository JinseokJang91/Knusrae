    ...
    <div id="comments" class="bg-white rounded-2xl shadow-lg p-8 mb-8">
            ...
            <div v-if="isLoggedIn" class="flex space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <div v-if="newCommentImagePreview" class="mt-2 relative inline-block">
                        ...
                        />
                        <button
                            @click="$emit('remove-comment-image')"
                    ...
                    <div class="flex justify-between items-center mt-2">
                        <label class="cursor-pointer" :class="{ 'opacity-50 cursor-not-allowed': isRecipeAuthor }">
                            <input
                                type="file"
                                accept="image/*"
                                @change="$emit('comment-image-select', $event)"
                                :disabled="isRecipeAuthor"
                                class="hidden"
                            />
        ...
        <div class="space-y-6">
            <div v-for="comment in comments" :key="comment.id" class="space-y-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button
                                    ...
                                    @click="$emit('toggle-reply-form', comment)"
                        ...
                        <div v-else>
                            ...
                            <button
                                ...
                                @click="$emit('toggle-replies-visibility', comment.id)"
                ...
                <!-- 답글 작성 폼 (최상위 댓글에 대한) -->
                <div
                    v-if="replyingToCommentId === comment.id && !comment.parentId"
                    class="ml-14 flex space-x-4 p-4 bg-orange-50 rounded-lg border-2 border-orange-200"
                >
