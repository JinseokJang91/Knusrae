        ...
        <div class="footer-content">
            ...
            <div class="footer-left">
                <div class="footer-logo-container">
                    <img :src="logoText" alt="너스레" class="footer-logo" />
                </div>
            ...
            <div class="footer-right">
                ...
                <div class="footer-links-group">
                    <a href="#" class="footer-link">ABOUT US</a><span class="divider">|</span>
                    <a href="#" class="footer-link">고객센터</a><span class="divider">|</span>
                    <a href="#" class="footer-link">이용약관</a><span class="divider">|</span>
